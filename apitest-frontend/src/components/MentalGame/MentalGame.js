    ...
    return (
       <div className={classes.container}>
        ...
        {/* <div className={classes.flashedMsg}>
            {loadingPostResult && <Message className={classes.loadingMessage} >...saving </Message>}
            {successPostResult && <FlashMessage><strong>Saved!</strong></FlashMessage> }
            {errorPostResult && <Message className={classes.errorMessage} >{errorPostResult}</Message>}
            
        </div> */}
        <button disabled={!isNotSubmitted} onClick={saveResultHandler} className={styles.btnPrimary}>
          Save Result
        </button>
       
        &nbsp;
        <button onClick={props.reTake} className={styles.btnPrimary}>Retake</button>
      </div>
    );
  }
